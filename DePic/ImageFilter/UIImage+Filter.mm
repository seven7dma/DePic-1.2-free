...
+(UIImage*)blur:(UIImage*)srcImage radius:(CGFloat)radius{
    ...
    UInt32* outPixels = (UInt32*)malloc(width*height * sizeof (UInt32));
...
//    free(pixels);
    ...
    CGDataProviderRef provider      = CGDataProviderCreateWithData(NULL, tempPixels, [data length], NULL);
